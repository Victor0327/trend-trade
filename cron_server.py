...
new_job = cron_manager.new(command='/home/flamingo/anaconda3/envs/python3.9.12/bin/python /usr/bin/trend-trade/robots/index.py >> /usr/bin/trend-trade/new_job.log 2>&1 &', comment='daily chart')
