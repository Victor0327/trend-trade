...
def run_child():
    ...
    main_engine.add_gateway(BinanceRpcGateway, "BINANCE")
    ...
    main_engine.connect(ctp_setting, "BINANCE")
    end = datetime.now(DB_TZ)
    start = end - timedelta(3)
    data = main_engine.query_history(HistoryRequest(
                symbol='BTCUSDT',
    ...
    print(data)
    main_engine.write_log("连接币安接口成功")
