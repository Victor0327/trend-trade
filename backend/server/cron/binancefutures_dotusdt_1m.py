...
# 唯一索引要手动创建
# CREATE UNIQUE INDEX "BINANCEFUTURES_DOTUSDT_dbbardata_symbol_exchange_interval_datet" ON "BINANCEFUTURES_DOTUSDT_dbbardata"(symbol text_ops,exchange text_ops,interval text_ops,datetime timestamp_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_DOTUSDT_dbbaroverview_symbol_exchange_interval" ON "BINANCEFUTURES_DOTUSDT_dbbaroverview"(symbol text_ops,exchange text_ops,interval text_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_DOTUSDT_dbtickdata_symbol_exchange_datetime" ON "BINANCEFUTURES_DOTUSDT_dbtickdata"(symbol text_ops,exchange text_ops,datetime timestamp_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_DOTUSDT_dbtickoverview_symbol_exchange" ON "BINANCEFUTURES_DOTUSDT_dbtickoverview"(symbol text_ops,exchange text_ops);
