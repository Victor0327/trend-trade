...
# 唯一索引要手动创建
# CREATE UNIQUE INDEX "BINANCEFUTURES_MINAUSDT_dbbardata_symbol_exchange_interval_datet" ON "BINANCEFUTURES_MINAUSDT_dbbardata"(symbol text_ops,exchange text_ops,interval text_ops,datetime timestamp_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_MINAUSDT_dbbaroverview_symbol_exchange_interval" ON "BINANCEFUTURES_MINAUSDT_dbbaroverview"(symbol text_ops,exchange text_ops,interval text_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_MINAUSDT_dbtickdata_symbol_exchange_datetime" ON "BINANCEFUTURES_MINAUSDT_dbtickdata"(symbol text_ops,exchange text_ops,datetime timestamp_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_MINAUSDT_dbtickoverview_symbol_exchange" ON "BINANCEFUTURES_MINAUSDT_dbtickoverview"(symbol text_ops,exchange text_ops);
