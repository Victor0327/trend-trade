...
# 唯一索引要手动创建
# CREATE UNIQUE INDEX "BINANCEFUTURES_ORDIUSDT_dbbardata_symbol_exchange_interval_datet" ON "BINANCEFUTURES_ORDIUSDT_dbbardata"(symbol text_ops,exchange text_ops,interval text_ops,datetime timestamp_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_ORDIUSDT_dbbaroverview_symbol_exchange_interval" ON "BINANCEFUTURES_ORDIUSDT_dbbaroverview"(symbol text_ops,exchange text_ops,interval text_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_ORDIUSDT_dbtickdata_symbol_exchange_datetime" ON "BINANCEFUTURES_ORDIUSDT_dbtickdata"(symbol text_ops,exchange text_ops,datetime timestamp_ops);
# CREATE UNIQUE INDEX "BINANCEFUTURES_ORDIUSDT_dbtickoverview_symbol_exchange" ON "BINANCEFUTURES_ORDIUSDT_dbtickoverview"(symbol text_ops,exchange text_ops);
