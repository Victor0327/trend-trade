...
scheduler.add_job(
    crypto_btcusdt_perpetual_15m.run,
    trigger=crypto_btcusdt_perpetual_15m.trigger,
    id=crypto_btcusdt_perpetual_15m.job_id,
    **crypto_btcusdt_perpetual_15m.trigger_args)
...
scheduler.add_job(
    ...
    **crypto_ethusdt_perpetual_15m.trigger_args)
